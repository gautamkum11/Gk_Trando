...
import q1img from "../images/q4.svg";
...
function Q4() {
    ...
    return (
        <div className = "q-1">
            ...
            <a href = "/q3"><img src = {lessthan} className = "back" /></a>
            <div className = "q-2">
                <p className = "q-3">Lets know more about you</p>
                <img src = {q1img} className = "q2image"/>
            </div>
            <form className = "q-4">
                <p className = "q2-4-1">Why you are learning eng?</p>
                <select placeholder = "Please Select..." className = "q-5" onChange = {handlechange}>
                    <option className = "q-5">for myself</option>
                    <option className = "q-5" >for work</option>
                    <option className = "q-5" >for exam</option>
