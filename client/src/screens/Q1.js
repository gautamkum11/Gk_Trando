...
import q1img from "../images/q1.svg";
...
function Q1() {
    ...
    return (
        <div className = "q-1">
            ...
            <form className = "q-4">
                <p className = "q-4-1">Who are you?</p>
                <select placeholder = "Please Select..." className = "q-5" onChange = {handlechange}>
                    <option className = "q-5">a student</option>
                    <option className = "q-5" >proficient in english</option>
                    <option className = "q-5" >a govt. school student</option>
